...
def download_model():
    ...
    Ham nay duoc goi mot lan khi module duoc import. Xac thuc thong qua
    IAM Role gan vao EC2 instance (instance profile), khong can access key
    tren VM.
    """
...
def score(req: ScoreRequest):
    ...
    label = "thu_nhap_cao" if pred[0] == 1 else "thu_nhap_thap"
